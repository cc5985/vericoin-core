VeriCoin version 0.4.1 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/VeriCoin/bitcoin-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxbitcoin or bitcoind the wallet will be rewritten, VeriCoin will
...
wxVeriCoin: new address visible on main window
