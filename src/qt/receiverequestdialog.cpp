...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatVeriCoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + VeriCoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatVeriCoinURI(info));
}
