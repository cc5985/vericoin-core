VeriCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/VeriCoin/bitcoin-0.5.4/
...
Fix VeriCoin-Qt notifications under Growl 1.3.
Increase required age of VeriCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVeriCoin properly when installing VeriCoin-Qt over it. (Windows)
