VeriCoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/VeriCoin/bitcoin-0.8.4/
...
code, causing the VeriCoin-Qt or bitcoind process to crash.
...
their own version of VeriCoin against Boost versions 1.50-1.52.
