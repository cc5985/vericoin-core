...
/** VeriCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VeriCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VeriCoinUnits(QObject *parent);
...
typedef VeriCoinUnits::Unit VeriCoinUnit;
