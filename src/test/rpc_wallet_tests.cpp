...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CVeriCoinAddress demoAddress = CVeriCoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CVeriCoinAddress setaccountDemoAddress = CVeriCoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CVeriCoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CVeriCoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
